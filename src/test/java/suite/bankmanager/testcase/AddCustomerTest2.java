...
//				System.out.println("TestCase:"+DataUtil.isTestRunnable("AddCustomerTest2",excel));
//				
//				System.out.println("Runmode for data:"+data.get("Runmode"));
				DataUtil.checkExecution("BankManagerSuite", "AddCustomerTest2", data.get("Runmode"), excel);
